...
pageMod.PageMod({
	...
	contentScriptFile: [data.url("jquery-1.12.0.js"), data.url("jszip.js"), data.url("jszip-utils.js"), "./dewey-content-script.js"],
	// production content script
	// contentScriptFile: [data.url("jquery-1.12.0.min.js"), data.url("jszip.min.js"), data.url("jszip-utils.min.js"), "./dewey-content-script.min.js"],
